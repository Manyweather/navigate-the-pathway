...
function ExperienceGraphic({ experience }: { experience: "compass" | "pathway" | "genesis" }) {
  ...
  return <svg viewBox="0 0 96 96" aria-hidden="true" focusable="false"><path d="m48 14 26 15v30L48 74 22 59V29l26-15Z" /><circle cx="48" cy="43" r="8" /><circle cx="31" cy="54" r="6" /><circle cx="65" cy="54" r="6" /><path className="experience-graphic-detail" d="M48 51v18M42 64h12M36 52l7-5M60 52l-7-5" /></svg>;
}
