...
function oacaBootstrap() {
  ...
  return {
    ...
    events,
    campaigns: [
      { id: "campaign-1", name: "Research identity invitation", subject: "Develop your research identity", previewText: "Reserve a place and bring your questions.", status: "sent", audience: { cohortLabels: ["Class of 2029"] }, scheduledFor: null, sentAt: isoAt(-4, 9), content: { heading: "Develop your research identity" }, deliveryChannel: "email", recipientCount: 76, deliveredCount: 73, openedCount: 52, clickedCount: 34, formSubmittedCount: 18, eventRegisteredCount: 24, appointmentRequestedCount: 11, minimumGroupSize: 10 },
      { id: "campaign-sms-1", name: "Practical testing reminder", subject: "Practical testing reminder", previewText: "Practical Practice Testing begins tomorrow at noon in Innovation Hall 210.", status: "sent", audience: { cohortLabels: ["Class of 2029"] }, scheduledFor: null, sentAt: isoAt(-1, 12), content: { heading: "Practical testing reminder", body: "Practical Practice Testing begins tomorrow at noon in Innovation Hall 210.", deliveryChannel: "sms" }, deliveryChannel: "sms", recipientCount: 76, deliveredCount: 61, openedCount: 0, clickedCount: 0, formSubmittedCount: 0, eventRegisteredCount: 0, appointmentRequestedCount: 0, minimumGroupSize: 10 },
    ],
