...
export const oacaServiceLines = [
  {
    ...
    description: "Meet with your permanent assigned academic advisor.",
  ...
  },
  {
    ...
    description: "Choose an eligible career advisor or the first available appointment.",
  ...
  },
  {
    key: "peer_tutoring",
    name: "Peer tutoring",
    description: "Choose a subject, eligible tutor, and tutoring format.",
