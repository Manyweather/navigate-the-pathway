...
const facilitiesAdminChapters: TutorialChapter[] = [
  orientation("facilities"),
  {
    ...
    steps: [
      ...
      step("facilities-control", "facilities-notifications", "Use the work-order notification bell", "Open the bell beside the Facilities brand to see urgent, overdue, unassigned, approval, response, and fulfillment alerts.", "Role-scoped attention", "The same alert record is filtered for Mike Neary, Facilities staff, or the department requester and links directly to the relevant work.", ".facilities-notification-button"),
    ],
  },
  {
    ...
    steps: [
      ...
      step("facilities-resources", "facilities-event-specifications", "Set event specifications and request details", "Publish versioned setup requirements, assign owners and deadlines, or pause only the approval or preparation step that needs a requester response.", "Keep work moving while resolving gaps", "Questions, responses, attachments, acceptance, and resumed steps remain attributed in the event history.", "[data-tutorial-id='facilities-event-specifications']"),
      ...
      step("facilities-resources", "facilities-supplies", "Fulfill office supplies inside Warehouse", "Routine in-stock quantities can auto-approve while high-volume, cross-department, restricted, or short-stock requests enter a visible review queue.", "One stock-aware supply flow", "Reservation, picking, partial fulfillment, backorder, and delivery states prevent the same stock from being promised twice.", "[data-tutorial-id='facilities-supplies']"),
...
const facilitiesRequesterChapters: TutorialChapter[] = [
  orientation("facilities"),
  {
    ...
    steps: [
      step("facilities-request", "facilities-request-home", "Your department request home", "Submit a work order, request supplies through Warehouse, or reserve a room, then follow its status and Facilities updates.", "Requester self-service", "Requesters see only their own department-facing records and do not receive approval queues, warehouse controls, or administrative reports.", "[data-tutorial-id='facilities-requester-home']"),
      step("facilities-request", "facilities-supplies", "Request office supplies from Warehouse", "See available quantities, needed-by dates, approval or backorder status, and fulfillment history in the same workspace as department inventory.", "Stock-aware service", "Rules auto-approve routine requests while preserving review for shortages, high quantities, or another department’s items.", "[data-tutorial-id='facilities-supplies']"),
