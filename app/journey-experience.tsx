    ...
    <main className="site-shell">
      ...
      <div className="experience" id="top">
        ...
        {view === "home" ? <section className="screen dashboard" aria-labelledby="home-title">
          ...
          <div className="pilot-entry-card"><div><span>Pilot participation</span><h2>Sessions and surveys</h2><p>Practice attendance, view survey availability, and keep course and Portfolio planning together.</p></div><button className="secondary-button" type="button" onClick={() => onOpenWorkspace("pilot")}>Open pilot checklist</button></div>
